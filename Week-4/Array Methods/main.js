...
// ******************Filter-Ex1****************************//
let Orange_vegetables=vegetables.filter(veg=> veg.color==="orange")
console.log(JSON.stringify(Orange_vegetables))
Orange_vegetables.forEach(evg=>console.log(evg.name))
...
let Compare=messagesFromDad.map(wor=> wor.toLowerCase())
Compare.forEach(a=> console.log(a))
...
let emails=users.map(em=>em.email)
console.log(emails)

let zipcode=users.filter(ad=>ad.address.zipcode[0]==="5")
console.log(zipcode)